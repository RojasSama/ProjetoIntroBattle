...
class Battle():
    def __init__(self, game):
        ...
        # self.player_team = self.game.selection.team
        self.turn = 'Player'
    ...
    def show_hp(self):
        ...
        self.game.draw_text(f'{Rogue.__name__} - {12} / {100}', 35, 850, 560, self.game.BLACK)
        self.game.draw_text(f'{Wizard.__name__} - {50} / {100}', 35, 850, 610, self.game.BLACK)
        self.game.draw_text(f'{Hunter.__name__} - {75} / {100}', 35, 850, 660, self.game.BLACK)
