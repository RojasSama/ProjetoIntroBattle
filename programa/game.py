...
class Game():
    def __init__(self):
        ...
        self.z_KEY, self.x_KEY, self.RIGHT_KEY, self.LEFT_KEY, self.START_KEY = False, False, False, False, False  # definindo o valor 'default' das teclas que serao usadas
    ...
    def game_loop(self):  # loop principal
        ...
        while self.playing:
            ...
            self.draw_text('Main Menu', 45, self.DISPLAY_W // 2, self.DISPLAY_H // 2)  # desenhando na tela usando os parametros largura e altura da tela
